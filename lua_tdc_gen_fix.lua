...
for i, line in ftcsv.parseLine("canshu.csv", ",", {bufferSize=50}) do
    ...
    temp_conf[4],temp_conf[5],temp_conf[6],temp_conf[7] = tdc.tdc_by_temperature_fix(xcfreq,xlen,xtfreq,17)

   -- print(temp_conf[1],temp_conf[2],temp_conf[3],temp_conf[4],temp_conf[5],temp_conf[6],temp_conf[7])
...
local file = assert(io.open("tdc_conf_fix.csv", "w"))
